...
export default function Bet() {
  ...
  const [dispute, setDispute] = useState({
    cadidate1: "Loading...",
    candidate2: "Loading...",
    image1: "https://static.wixstatic.com/media/1f8274_944ad77c3c45481089668dac2995e335~mv2.jpg/v1/fill/w_500,h_500,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/1f8274_944ad77c3c45481089668dac2995e335~mv2.jpg",
    image2: "https://static.wixstatic.com/media/1f8274_944ad77c3c45481089668dac2995e335~mv2.jpg/v1/fill/w_500,h_500,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/1f8274_944ad77c3c45481089668dac2995e335~mv2.jpg",
    total1: 0,
    total2: 0,
    winner: 0
  });
  ...
  useEffect(() => {
    ...
    getDispute()
      ...
      .catch(err => {
        console.err(err.data ? err.data : err);
